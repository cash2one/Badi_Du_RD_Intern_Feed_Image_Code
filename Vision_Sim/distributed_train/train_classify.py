...
def main(_):
  ...
  with tf.Graph().as_default():
    ...
    def create_clones(deploy_config, mini_batch_examples, mini_batch_labels):
        clones = []
            ...
            with tf.name_scope(deploy_config.clone_scope(i)) as clone_scope:
                with tf.device(clone_device):
                    with tf.variable_scope(tf.get_variable_scope(),
                        ...
                        with slim.arg_scope([slim.model_variable, slim.variable],
                                            device=deploy_config.variables_device()):
                            outputs = resnet_vision.inference(mini_batch_examples[i], mini_batch_labels[i], 
    ...
    clones = create_clones(deploy_config, mini_batch_examples, mini_batch_labels)
