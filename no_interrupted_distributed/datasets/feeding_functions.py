...
class _GeneratorFeedFn(object):
  ...
  def __init__(self,
               ...
               seed=None,
               num_epochs=None):
    meta = next(generator(True)) #first get meta, include types and shapes for each colum
